...
The samples were identified as: `r names(OutlierFilter)[OutlierFilter]` these 
seem to be clear outlier samples, indeed if the loadings in the first and 
second dimension is found it is seen that they have just 2 outlier 
features `r feats`.
