...
## Calculate normalization factors based on the top x features with highest
## abundances per sample. Normalization will hence be independent of
## gap-filling. Assumption is that the intensity of the top x highest
## intensity features is comparable across samples (independently which
## compound/metabolite these features might be).
