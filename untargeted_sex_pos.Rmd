...
```{r heatmap-VBS, fig.path = IMAGE_PATH, fig.width = 15, fig.height = 10, fig.cap = "Heatmap of features for venous samples.", echo = FALSE}
## Create heatmap
tmp <- log2(assay(
...
```{r heatmap plasma, fig.path = IMAGE_PATH, fig.width = 15, fig.height = 10, fig.cap = "Heatmap of features for plasma samples.", echo = FALSE}
## Create heatmap
tmp <- log2(assay(
...
We now want to compare the list of top 100 features with the smallest p-value
across the three sample sources. Therefore, we use the `UpSetR` package.
...
Of the top 100 features with lowest p-value, 22 were found common in capillary
and venous blood samples, 19 in venous blood and plasma samples, 2 in capillary
and plasma samples and one in all 3 matrices.
...
Coefficients for capillary and venous samples appear to be more similar while
for many features the coefficients in plasma samples have an opposite sign.
