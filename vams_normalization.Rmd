...
#for (i in seq(nrow(is_info))) {
 ...
 #  is_info$mz_ion[i] <- mass2mz(is_info$mzneut[i], adduct = is_info[i, "POS"])[1, 1]
#}
...
An approach that has been proposed for metabolomics data normalization
...
The raw 75% MRA of replicated samples is between 1.2 and 2.2 which is quite OK,
