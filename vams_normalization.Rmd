...
dpks_dens <- density(log2(tmp_pks[!chromPeakData(data_pos)$is_filled, "into"]))
fpks_dens <- density(log2(tmp_pks[chromPeakData(data_pos)$is_filled, "into"]))
...
dpks_dens <- density(
    log2(tmp_pks[!chromPeakData(data_pos)$is_filled[pk_idxs], "into"]))
fpks_dens <- density(
    log2(tmp_pks[chromPeakData(data_pos)$is_filled[pk_idxs], "into"]))
yl <- c(0, max(dpks_dens$y, fpks_dens$y))
xl <- range(dpks_dens$x, fpks_dens$x)
