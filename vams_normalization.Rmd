...
```{r PCA-raw-normalized, fig.path = IMAGE_PATH, fig.width = 12, fig.height = 12, fig.cap = "PCA of raw and normalized feature abundances. Circles and rectangles indicate sample different batches."}
...
```{r PCA-raw-normalized-IS, fig.path = IMAGE_PATH, fig.width = 12, fig.height = 12, fig.cap = "PCA of raw and normalized feature abundances for internal standards. Circles and rectangles indicate sample different batches."}
pc_raw <- prcomp(
