...
# c("Creatine-full", "FT5630") and c("Creatinine-full", "FT5631") not considered 
# for now 

mo <- filterMatches(mo, queryValues = keep[, 2], 
                    targetValues = keep[, 1], 
...
Note however that the signal for Homocysteine is also not that clear and the
assigned feature might represent data from multiple different compounds (see
below).

![](images/differential_abundance_pos/standards/Homocysteine-FT0178.png)

For SAH on the other hand the assigned feature is less ambiguous:
