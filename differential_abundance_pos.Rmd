...
std_info$feature[std_info$name == "Acetylglucosamine"] <- "FT0518"
...
tmp_capillary <- res_cap

pc_raw_capillary <- prcomp(t(log2(assay(tmp_capillary, "normalized_filled_imputed"))),
...
pc_raw_venous <- prcomp(t(log2(assay(tmp_venous, "normalized_filled_imputed"))),
                 scale = FALSE, center = TRUE)
...
pc_raw_plasma <- prcomp(t(log2(assay(tmp_plasma, "normalized_filled_imputed"))),
                 scale = FALSE, center = TRUE)
