...
```{r known-compounds-subset, echo = FALSE}
...
```{r result-table-known-compounds, echo = FALSE, results = "asis"}
## Write result table
...
```{r known-compounds-pca-all, echo = FALSE}
pc <- prcomp(t(log2(assay(std_res_MF, "normalized_filled_imputed"))),
                 center = TRUE, scale. = FALSE)
```

```{r known-compounds-pca-plot, fig.path = IMAGE_PATH, fig.cap = "PCA of the samples based on intensities of known sex-related compounds.", fig.width = 7 * phi, fig.height = 7, echo = FALSE}
par(mfrow = c(1, 2))
...
```{r standards-pca-without-RBC, echo = FALSE}
pc <- prcomp(t(log2(assay(std_res_MF, "normalized_filled_imputed"))),
                 center = TRUE, scale. = FALSE)
```

```{r standards-pca-plot-without-RBC, fig.path = IMAGE_PATH, fig.cap = "PCA of the samples based on intensities of known sex-related compounds.", fig.width = 7 * phi, fig.height = 7, echo = FALSE}
...
```{r standards-pca-cap2, echo = FALSE}
pc <- prcomp(t(log2(assay(res_cap, "normalized_filled_imputed"))),
                 center = TRUE, scale. = FALSE)
```

```{r standards-pca-plot-cap2, fig.path = IMAGE_PATH, fig.cap = "PCA of the samples based on intensities of known sex-related compounds.", fig.width = 7 * phi, fig.height = 7, echo = FALSE}
...
library(rgl)
 ...
 ## list of your top n selected parameters
...
```{r standards-pca-ven2, echo = FALSE}
pc <- prcomp(t(log2(assay(res_ven, "normalized_filled_imputed"))),
                 center = TRUE, scale. = FALSE)
```

```{r standards-pca-plot-ven2, fig.path = IMAGE_PATH, fig.cap = "PCA of the samples based on intensities of known sex-related compounds.", fig.width = 7 * phi, fig.height = 7, echo = FALSE}
...
```{r standards-pca-plasma2, echo = FALSE}
pc <- prcomp(t(log2(assay(res_plas, "normalized_filled_imputed"))),
                 center = TRUE, scale. = FALSE)
```

```{r standards-pca-plot-plasma2, fig.path = IMAGE_PATH, fig.cap = "PCA of the samples based on intensities of known sex-related compounds.", fig.width = 7 * phi, fig.height = 7, echo = FALSE}
...
TopPar <- c("FT1481", "FT0312", "FT0168", "FT3776", "FT0216") ## list of your top n selected parameters
data <- t(log2(assay(std_res_MF, "normalized_filled_imputed")))
