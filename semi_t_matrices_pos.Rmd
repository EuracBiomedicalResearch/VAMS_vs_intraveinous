...
res_capven = std_res[, std_res$source == "capillary"] & std_res[, std_res$source == "capillary"]
res_venplas = std_res[, std_res$source == "venous" & std_res$source == "plasma"]
res_capplas = std_res[, std_res$source == "capillary" & std_res$source == "plasma"]
...
source <- factor(res_capven$source)
sex <- factor(res_capven$sex)
...
30 features were found to be significant when comparing capillary and venous 
blood samples.
