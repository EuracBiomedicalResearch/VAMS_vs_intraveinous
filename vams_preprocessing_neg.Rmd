...
for (i in 1:nrow(neg_cmps)) {
    ...
    ## Draw ALL peaks within the region
    highlightChromPeaks(data_neg, rt = rt_pks, mz = mz_pks,
                        border = paste0(col_source[data_neg$source], 20),
                        whichPeaks = "apex_within")
    ## Draw only peaks that have the apex within the expected rt
    highlightChromPeaks(data_neg, rt = rtr, mz = mzr,
                        col = paste0(col_source[data_neg$source], 20),
                        whichPeaks = "apex_within", type = "polygon")
...
aligned chromatograms (see e.g. Succinic Acid and Acetylmethionine below). Few
exceptions exist, such as Phosphoenolpyruvic Acid (the third plot below).

![](images/vams_preprocessing/kc_20_chrom_plot_adjusted.png)

![](images/vams_preprocessing/kc_93_chrom_plot_adjusted.png)

![](images/vams_preprocessing/kc_65_chrom_plot_adjusted.png)
