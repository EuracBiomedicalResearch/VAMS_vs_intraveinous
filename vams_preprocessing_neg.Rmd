...
time_stamp <- extractTimeStamps(data_neg)
data_neg$time_stamp <- time_stamp
stopifnot(all(data_neg$inj_idx, order(data_neg$time_stamp)))
```
...
kcs <- rbind(
    ...
    kc_65 = c(218, 230, 0),           # SKIP peak more than 10 seconds away
    ...
    kc_74 = c(30, 35, 0),             # SKIP, too low signal
    ...
    kc_81 = c(157, 161, 1),           # 60000 OK, 3 peaks (kc_81-83) (?)
    kc_82 = c(160, 166, 1),           # 50000 OK, 3 peaks (kc_81-83) (?)
...
chromatographic peaks for some known compounds is surprisingly large. We use thus
