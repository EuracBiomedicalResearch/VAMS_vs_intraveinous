...
#' 416293 (mz 714.5825, 714.5882, rt 199.7670, 210.0900) is strange...
...
rtr <- c(65, 100)
chr_1 <- chromatogram(filterFile(data_pos, 74), mz = mzr, rt = rtr)
chr_2 <- chromatogram(filterFile(data_pos_proc, 74), mz = mzr, rt = rtr)
par(mfrow = c(2, 1))
plot(chr_1)
plot(chr_2)
...
rtr <- c(25, 55)
chr_1 <- chromatogram(filterFile(data_pos, 111), mz = mzr, rt = rtr)
chr_2 <- chromatogram(filterFile(data_pos_proc, 111), mz = mzr, rt = rtr)
par(mfrow = c(2, 1))
plot(chr_1)
plot(chr_2)

#' weird: "CP562116": seems to have just a single peak - and the merged does
#' not show any at all.
