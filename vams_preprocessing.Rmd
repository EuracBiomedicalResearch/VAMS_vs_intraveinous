...
grouped. Also, we reduce the `binSize` parameter to allow definition of features
that are present in fewer individuals.
...
for (i in 1:nrow(pos_cmps)) {
    ...
    plot_grouping(data_pos, rt = rtr, mz = mzr, param = pdp,
                  col = paste0(col_source[data_pos$source], 80),
                  simulate = FALSE)
    dev.off()    
}
