...
mnp <- MergeNeighboringPeaksParam(expandRt = 4, expandMz = 0.001)
...
In total xxx peaks were merged, which reduced the total number of peaks in the
...
for (i in 1:nrow(std_info)) {
    ...
    xcms:::.add_chromatogram_peaks(
               chr, pks,
               col = paste0(sample_colors[pks[, "column"]], 60),
               bg = NA,
               type = "rectangle")
