...
The majority of known compounds, 42 features, are present in all three sample
sources, whereas 12 features are only present in capillary and venous blood 
samples and 8 features are only present in capillary blood samples. 4 features
are present in plasma and venous blood samples, but absent in capillary blood 
samples and 3 features are only present in plasma samples, one feature is 
